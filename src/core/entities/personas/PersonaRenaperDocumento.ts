export class PersonaRenaperDocumento {
  private id;
  ...
  constructor(personaRenaperDocumento: {
    ...
    this.fecha_nacimiento_renaper = personaRenaperDocumento.fecha_nacimiento_renaper;
    this.fecha_defuncion_renaper = personaRenaperDocumento.fecha_defuncion_renaper;
    this.persona_documento_id = personaRenaperDocumento.persona_documento_id;
    this.lugar_nacimiento = personaRenaperDocumento.lugar_nacimiento;
