...
function initModels(sequelize) {
  ...
  roles.belongsToMany(users, {
    as: 'user_id_users_user_roles',
    through: user_role,
    foreignKey: 'role_id',
    otherKey: 'user_id',
  });
  users.belongsToMany(clients, {
    as: 'client_id_clients',
    through: user_client,
    foreignKey: 'user_id',
    otherKey: 'client_id',
  });
  ...
  user_client.belongsTo(clients, { as: 'client', foreignKey: 'client_id' });
  clients.hasMany(user_client, { as: 'user_clients', foreignKey: 'client_id' });
  ...
  persona_declaraciones_consolidadas.belongsTo(persona_renaper, {
    as: 'persona_renaper',
    foreignKey: 'persona_renaper_id',
  });
  persona_renaper.hasOne(persona_declaraciones_consolidadas, {
    as: 'persona_declaraciones_consolidada',
    foreignKey: 'persona_renaper_id',
  });
  ...
  persona_dato_declarado.belongsTo(persona_sisu_declarada, {
    as: 'cod_identificador_persona_sisu_declarada',
    foreignKey: 'cod_identificador',
  });
  persona_sisu_declarada.hasMany(persona_dato_declarado, {
    as: 'persona_dato_declarados',
    foreignKey: 'cod_identificador',
  });
  persona_declaraciones_consolidadas.belongsTo(persona_sisu_declarada, {
    as: 'cod_identificador_persona_sisu_declarada',
    foreignKey: 'cod_identificador',
  });
  persona_sisu_declarada.hasMany(persona_declaraciones_consolidadas, {
    as: 'persona_declaraciones_consolidadas',
    foreignKey: 'cod_identificador',
  });
  persona_declaraciones_consolidadas.belongsTo(persona_sisu_declarada, {
    as: 'ultima_revision_persona_sisu_declarada',
    foreignKey: 'ultima_revision',
  });
  persona_sisu_declarada.hasMany(persona_declaraciones_consolidadas, {
    as: 'ultima_revision_persona_declaraciones_consolidadas',
    foreignKey: 'ultima_revision',
  });
  persona_declaraciones_revisadas.belongsTo(persona_sisu_declarada, {
    as: 'persona_revision_declaracione',
    foreignKey: 'persona_revision_declaraciones_id',
  });
  persona_sisu_declarada.hasMany(persona_declaraciones_revisadas, {
    as: 'persona_declaraciones_revisadas',
    foreignKey: 'persona_revision_declaraciones_id',
  });
  persona_direccion.belongsTo(persona_sisu_declarada, { as: 'direccion', foreignKey: 'direccion_id' });
  persona_sisu_declarada.hasMany(persona_direccion, { as: 'persona_direccions', foreignKey: 'direccion_id' });
  persona_direccion.belongsTo(persona_sisu_declarada, {
    as: 'cod_identificador_persona_sisu_declarada',
    foreignKey: 'cod_identificador',
  });
  persona_sisu_declarada.hasMany(persona_direccion, {
    as: 'cod_identificador_persona_direccions',
    foreignKey: 'cod_identificador',
  });
  ...
  persona_renaper_documento.belongsTo(persona_sisu_declarada, {
    as: 'persona_documento_version_actual_persona_sisu_declarada',
    foreignKey: 'persona_documento_version_actual',
  });
  persona_sisu_declarada.hasMany(persona_renaper_documento, {
    as: 'persona_renaper_documentos',
    foreignKey: 'persona_documento_version_actual',
  });
  persona_renaper_documento.belongsTo(persona_sisu_declarada, {
    as: 'persona_renaper',
  ...
  persona_sisu_declarada.hasMany(persona_renaper_documento, {
    as: 'persona_renaper_persona_renaper_documentos',
    foreignKey: 'persona_renaper_id',
  });
  persona_renaper_documento_version.belongsTo(persona_sisu_declarada, {
    as: 'persona_documento',
    foreignKey: 'persona_documento_id',
  });
  persona_sisu_declarada.hasMany(persona_renaper_documento_version, {
    as: 'persona_renaper_documento_versions',
    foreignKey: 'persona_documento_id',
  });
  persona_revision_declaraciones.belongsTo(persona_sisu_declarada, {
    as: 'cod_identificador_persona_sisu_declarada',
    foreignKey: 'cod_identificador',
  });
  persona_sisu_declarada.hasMany(persona_revision_declaraciones, {
    as: 'persona_revision_declaraciones',
    foreignKey: 'cod_identificador',
  });
  persona_sisu_declarada.belongsTo(persona_sisu_declarada, {
    as: 'persona_renaper_persona_sisu_declarada',
    foreignKey: 'persona_renaper_id',
  });
  persona_sisu_declarada.hasMany(persona_sisu_declarada, {
    as: 'persona_sisu_declaradas',
    foreignKey: 'persona_renaper_id',
  });
  persona_sisu_declarada.belongsTo(persona_sisu_declarada, { as: 'persona_origen', foreignKey: 'persona_origen_id' });
  persona_sisu_declarada.hasMany(persona_sisu_declarada, {
    as: 'persona_origen_persona_sisu_declaradas',
    foreignKey: 'persona_origen_id',
  });
  temporal_revision.belongsTo(persona_sisu_declarada, {
    as: 'cod_identificador_persona_sisu_declarada',
    foreignKey: 'cod_identificador',
  });
  ...
  user_client.belongsTo(users, { as: 'user', foreignKey: 'user_id' });
  users.hasMany(user_client, { as: 'user_clients', foreignKey: 'user_id' });
