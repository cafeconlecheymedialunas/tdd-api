...
function initModels(sequelize) {
  ...
  persona_sisu_declarada.hasMany(persona_direccion, { as: "cod_identificador_persona_direccions", foreignKey: "cod_identificador"});
  ...
  persona_sisu_declarada.hasMany(persona_renaper_documento, { as: "persona_renaper_documentos", foreignKey: "persona_documento_version_actual"});
  persona_renaper_documento.belongsTo(persona_sisu_declarada, { as: "persona_renaper", foreignKey: "persona_renaper_id"});
  persona_sisu_declarada.hasMany(persona_renaper_documento, { as: "persona_renaper_persona_renaper_documentos", foreignKey: "persona_renaper_id"});
  ...
  persona_sisu_declarada.hasMany(persona_sisu_declarada, { as: "persona_sisu_declaradas", foreignKey: "persona_renaper_id"});
  persona_sisu_declarada.belongsTo(persona_sisu_declarada, { as: "persona_origen", foreignKey: "persona_origen_id"});
  persona_sisu_declarada.hasMany(persona_sisu_declarada, { as: "persona_origen_persona_sisu_declaradas", foreignKey: "persona_origen_id"});
